...
//    }
    /**
     * Test of deleteCommandeById method, of class CommandeService.
     */
    @Test
    public void testDeleteCommandeById() {
        System.out.println("deleteCommandeById");
        String idCommande = "CMD02";
        CommandeService instance = new CommandeService();
        int result = instance.deleteCommandeById(idCommande);
        System.out.println(result);
    }
